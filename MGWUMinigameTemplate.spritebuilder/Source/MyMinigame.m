...
-(id)init {
    if ((self = [super init])) {
        ...
        self.instructions = @"Get the diamonds quick before you run out of time!\nWatch out for the spikes and the rotating buzz saw!\nYou get 20 point per diamond and there are 5 diamond to grab.\n100 points total!\nGood Luck!!...";
    }
